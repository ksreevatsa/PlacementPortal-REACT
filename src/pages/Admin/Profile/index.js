                ...
                <div className="flex flex-1 justify-center items-center">
                    <div className="p-6 bg-gray-200 shadow-lg rounded-lg max-w-sm w-full text-center relative -top-24"> {/* Adjusting position here */}
                        ...
                        <div className="space-y-2 text-left">
                            <h2 className="text-lg"><span className="font-semibold">Id:</span> {user.id}</h2>
                            <h2 className="text-lg"><span className="font-semibold">Name:</span> {user.name}</h2>
                            <h2 className="text-lg"><span className="font-semibold">Email:</span> {user.email}</h2>
                            <h2 className="text-lg"><span className="font-semibold">Role:</span> {user.role}</h2>
                        </div>
                    </div>
                </div>
            </main>
